...
## Overview
As described [previously]{{ ref "/tyk-multi-data-centre/#managing-geographically-distributed-gateways-to-minimise-latency-and-protect-data-sovereignty"}}, Acme Global Bank has operations and customers in both the EU and USA.
