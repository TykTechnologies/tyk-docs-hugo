...
* Redis (check [supported versions](/planning-for-production/redis/))
* Dashboard
...
To make things easier, we will first set a few [environment variables](/tyk-configuration-reference/environment-variables/):
