...
Please note that it is not possible to override the default message for HTTP 404 errors, which indicate that the requested resource was not available (e.g. the requested URL does not exist).
