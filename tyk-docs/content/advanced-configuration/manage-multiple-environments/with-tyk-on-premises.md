...
![Advanced options tab location]({{< ref "img/2.10/advanced_options_designer.png" >}})

Then scroll down to the *Segment Tags* section:

![Segement tags section]({{< ref "img/2.10/segment_tags.png" >}})
...
![List of available Gateways]({{< ref "img/dashboard/system-management/list-gateways.png" >}})
...
![List of segment tags]({{< ref "img/dashboard/system-management/list-segment-tags.png" >}})

Also, for every Gateway selected, there will be an API URL presented at the top of the page, within the *Core Settings* tab.

![List of API URLs]({{< ref "img/dashboard/system-management/list-api-urls.png" >}})
