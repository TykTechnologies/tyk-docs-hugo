...
If you are deploying the **Tyk Enterprise Developer Portal**, set the appropriate values under the `enterprisePortal` section in your `values.yaml`. Please visit this [page](https://tyk.io/docs/portal/install) for a step by step installation of Tyk Enterprise Developer Portal.
