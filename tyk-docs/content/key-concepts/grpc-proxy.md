...
Tyk supports Mutual Authentication in gRPC. See [Mutual TLS]({{< ref "basic-config-and-security/security/tls-and-ssl/mutual-tls/" >}}) to configure Mutual Authentication in Tyk. 
