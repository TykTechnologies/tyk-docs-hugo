...
When selecting a Tyk Self-managed license [(see the pricing page to compare the licenses)](https://tyk.io/price-comparison), you can choose between three deployment models: [Launch]({{< ref "tyk-on-premises/licensing.md#launch---perfect-to-get-started" >}}), [Flex]({{< ref "tyk-on-premises/licensing.md#flex---for-multiple-teams-within-a-single-data-center-or-cloud" >}}) and [Global Multi-team]({{< ref "tyk-on-premises/licensing.md#global-multi-team---for-the-largest-global-enterprises-at-scale" >}}). Read below to learn which model fits best for your scenario. 
