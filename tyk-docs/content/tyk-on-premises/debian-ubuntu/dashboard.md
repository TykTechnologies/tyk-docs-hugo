...
Follow the [Gateway installation instructions]({{< ref "getting-started/installation/with-tyk-on-premises/on-ubuntu/gateway/" >}}) to connect to your Dashboard instance before you continue on to step 4.
