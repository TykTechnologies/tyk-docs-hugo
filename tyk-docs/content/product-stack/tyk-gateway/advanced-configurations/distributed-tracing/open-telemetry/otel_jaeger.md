...
For Kubernetes instructions, please refer to [How to integrate with Jaeger on Kubernetes]({{< ref "product-stack/tyk-gateway/advanced-configurations/distributed-tracing/open-telemetry/otel_jaeger_k8s" >}}).
