...
|         | Helm Chart (tyk-stack, tyk-oss, tyk-dashboard, tyk-gateway) v1.6.1 To Be Published (TBP) | Helm all versions |
...
The example Gateway configuration file `tyk.conf.example` has been updated to set exact matching with:
