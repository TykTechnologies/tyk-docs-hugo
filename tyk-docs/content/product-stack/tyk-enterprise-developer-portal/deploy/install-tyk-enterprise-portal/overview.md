...
{{< badge read="10 mins" href="/product-stack/tyk-enterprise-developer-portal/deploy/install-tyk-enterprise-portal/kubernetes/install-portal-using-new-helm" image="/img/k8s.png" alt="Kubernetes install">}}
