...
To upgrade the portal's theme please follow [the upgrade instructions]({{< ref "/tyk-stack/tyk-developer-portal/enterprise-developer-portal/customise-enterprise-portal/theme-upgrades" >}}) for the portal's themes.
