...
[_Tyk Sync_]({{< ref "/product-stack/tyk-dashboard/release-notes/version-5.1.md" >}}). We have now extended this feature and it is now possible to do this without
...
- Added a feature to display a full [_Tyk Sync_]({{<ref "/product-stack/tyk-dashboard/release-notes/version-5.1.md" >}}) command that will allow a user to import an example UDG into their Dashboard
