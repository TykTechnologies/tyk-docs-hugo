...
**Security Consideration:** Plan how users will [authenticate]({{< ref "api-management/security-best-practices#authentication" >}}). Will they use [tokens]({{< ref "api-management/client-authentication#use-bearer-tokens" >}}) or [OAuth]({{< ref "api-management/client-authentication#set-up-oauth-20-authorization" >}}) (for user-specific access)? Tyk offers tools to implement any of these methods effectively.
