...
- **Kubernetes Integration with Tyk Operator**: If your API runs on Kubernetes, [Tyk Operator]({{< ref "tyk-operator" >}}) integrates with Kubernetes to help you manage deployments as Kubernetes resources.
