...
See our [JWT Scope docs](/advanced-configuration/integrate/api-auth-mode/open-id-connect/#jwt-scope-to-policy-mapping-support) for more details.
...
See our [Golang plugin documentation](/plugins/golang-plugins/golang-plugins) for more details.
...
See our [Distributed Tracing documentation](/advanced-configuration/opentracing/) for more details.
...
See our updated [Getting Started](/getting-started/installation/with-tyk-on-premises/) section and [new CLI documentation](/getting-started/installation/with-tyk-on-premises/bootstrapper-cli/).
...
See our [Dashboard SSO documentation](/tyk-apis/tyk-dashboard-api/sso/) for more details.

### Importing WSDL APIs

WSDL now is a first class citizen at Tyk. You can take your WSDL definition and simply import to the Dashboard, creating a nice boilerplate for your service. See [Import APIs](/tyk-configuration-reference/import-apis/) for more details.
