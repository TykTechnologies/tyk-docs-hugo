...
See our updated [Tutorials](/try-out-tyk/tutorials/tutorials/) section.
...
Read more about the [GraphQL](/graphql/) and [Universal Data Graph](/universal-data-graph/)
...
See updated tutorials on how to [create a policy](/try-out-tyk/tutorials/create-security-policy) and [keys](/try-out-tyk/tutorials/create-api-key/)
...
See [updated flow details](/getting-started/tyk-components/identity-broker/)
...
At the moment the Response hook is supported for [Python and gRPC plugins](/plugins/rich-plugins/rich-plugins-work/#overriding-response).
...
[Read More](/analytics-and-reporting/useful-debug-modes/#enabling-detailed-logging)
...
[Read More](/planning-for-production/ensure-high-availability/load-balancing/#configure-load-balancing-and-weighting-via-the-dashboard)
...
[Read More](/tyk-configuration-reference/tyk-pump-configuration/tyk-pump-configuration/#sharding-analytics-to-different-data-sinks)
...
If you are upgrading from version 2.8, pls [read this guide](/release-notes/version-2.9/#upgrading-from-version-28)
