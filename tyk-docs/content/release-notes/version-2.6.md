...
See the Keys section of the [Tyk Gateway REST API](/tyk-rest-api/) Swagger doc for more details.
...
See [Developer Profiles](/tyk-developer-portal/developer-profiles/#reset-developer-password) for more details.
