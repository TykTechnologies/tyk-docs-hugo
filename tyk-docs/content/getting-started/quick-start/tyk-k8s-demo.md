...
- GCP:
    ...
    - `GOOGLE_APPLICATION_CREDENTIALS` environment variable per [google documentation]({{< ref "https://cloud.google.com/docs/authentication/application-default-credentials" >}})
- Azure:
