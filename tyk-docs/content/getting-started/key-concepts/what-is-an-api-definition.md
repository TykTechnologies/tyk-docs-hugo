...
The *Tyk API Definitions* which are written in as JSON objects.

We have 2 main type of definitions -
- **Tyk OAS API definiton** - Our new format, comply with the OpenAPI Spec schema according to the OpenAPI Specification standard. It has a [Tyk OAS API definito Schema](https://github.com/TykTechnologies/tyk-schemas/blob/main/JSON/draft-04) which you can use in your IDE.
