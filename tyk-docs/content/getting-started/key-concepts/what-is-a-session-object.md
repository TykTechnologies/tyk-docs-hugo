...
A session object is just a JSON object. For more details of each parameter in the session object, see [Tyk Token Session Object Details](/tyk-apis/tyk-gateway-api/token-session-object-details/).
