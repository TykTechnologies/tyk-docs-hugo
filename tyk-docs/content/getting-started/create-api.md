...
weight: 3
aliases:
  - /migration-to-tyk#tyk-self-managed/tutorials/tyk-on-premise-pro/create-api/
...
To embark on your API journey with Tyk Cloud, we recommend going to our [Quick Start guide]({{< ref "/migration-to-tyk#transition-to-tyk-cloud" >}}). This guide will walk you through the process of creating your very first API in Tyk Cloud.
