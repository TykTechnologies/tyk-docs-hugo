...
- `issuedAtValidationSkew` , `notBeforeValidationSkew`, `expiresAtValidationSkew` can be used to [configure clock skew](api-management/authentication/json-web-token#adjust-jwt-clock-skew-configuration) for json web token validation.
