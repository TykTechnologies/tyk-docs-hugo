...
Tyk OAS API support is currently in [Early Access]({{< ref "developer-support/special-release-and-features/early-access-features" >}}) and some Tyk features are not yet supported. You can see the status of what is and isn't yet supported [here]({{< ref "/getting-started/using-oas-definitions/oas-reference.md" >}}).
{{< /note >}}
