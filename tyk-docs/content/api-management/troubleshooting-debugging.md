...
1. ##### Capturing detailed logs
    ...
    **What is detailed request logging?**
    ...
    This mode is configured in the gateway and can be enabled at the [system]({{< ref "api-management/logs-metrics#configuration-at-the-gateway-level" >}}), [API]({{< ref "api-management/logs-metrics#configuration-at-the-api-level" >}}) or [access key]({{< ref "api-management/logs-metrics#configuration-at-the-key-level" >}}) level.
