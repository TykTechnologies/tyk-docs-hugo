...
When working with GraphQL APIs in Tyk, understanding schema types is crucial for proper API design and implementation. This guide covers the standard types supported by Tyk, custom scalar types, and best practices for type definitions.
...
1. **Custom Scalar Serialization**
   ...
   - Validation must be handled by the upstream service
