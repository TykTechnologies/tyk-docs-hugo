...
Using [this](https://bit.ly/39jUnuq) API definition, you can create a Tyk OAS API on your Tyk Gateway that forwards requests to the [Swagger Petstore](https://petstore3.swagger.io) request/response service.
