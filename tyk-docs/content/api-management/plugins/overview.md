...
*   [Golang]({{< ref "plugins/supported-languages/golang" >}}): A plugin written in Golang is called a **Native Plugin**. Tyk recommends using Go plugins for performance, flexibility, and nativity reasons (all Tyk components are written in Go).
*   [JavaScript]({{< ref "plugins/supported-languages/javascript-middleware" >}}): A plugin written in Javascript uses JavaScript Virtual Machine (JSVM) interpreter.
