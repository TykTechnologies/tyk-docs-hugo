...
<div style="display: flex; justify-content: center;">
{{< img src="/img/streams/tyk-streams-getting-started.png" alt="How Tyk Streams work" >}}
</div>

Let's break down how Tyk Streams facilitates this, focusing on the distinct producer and consumer roles Tyk plays:

#### Use Case: Tyk as an API Producer Gateway (Client to Stream)
...
#### Use Case: Tyk as an API Consumer Gateway (Stream to Client)
