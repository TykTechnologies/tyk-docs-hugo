...
- [Request Validation]({{< ref "api-management/traffic-transformation#validate-request-overview" >}})  - Tyk can protect your APIs by automatically validating the request parameters and payload against a schema that defines what it *should* look like
