...
![Welcome-Email]({{< ref "img/2.10/welcome_email_config.png" >}})
...
![Email-Customisation]({{< ref "img/2.10/key_approval_email_config.png" >}})
...
![Email-Image]({{< ref "img/2.10/key_approval_image_link.png" >}})
...
![Portal-Manager-Email]({{< ref "img/2.10/portal_manager_email_config.png" >}})
