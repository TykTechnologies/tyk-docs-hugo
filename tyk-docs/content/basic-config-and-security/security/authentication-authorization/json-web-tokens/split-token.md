...
![Split Token]({{< ref "img/2.10/split_token2.png" >}})
...
![Split Token]({{< ref "img/2.10/split_token3.png" >}})

And also the key’s metadata:

![Split Token]({{< ref "img/2.10/split_token1.png" >}})
...
![Split Token]({{< ref "img/2.10/split_token4.png" >}})
