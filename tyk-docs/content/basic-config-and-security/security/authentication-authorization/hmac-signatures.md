...
Tyk implements the [draft-cavage-http-signatures-05](http://tools.ietf.org/html/draft-cavage-http-signatures-05) draft of the HMAC Request Signing standard.
...
### Validating the signature of incoming requests
