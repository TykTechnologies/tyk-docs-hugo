...
There are other security options available from the Dashboard config file. See the [security section]({{< ref "tyk-configuration-reference/tyk-dashboard-configuration-options/#security" >}}) for more details.
