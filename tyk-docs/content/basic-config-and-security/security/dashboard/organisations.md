...
Self-Managed users should use [API tagging]({{< ref "advanced-configuration/manage-multiple-environments/with-migration-to-tyk#tyk-self-managed >}}) and enforce a tagging standard across all organizations.
