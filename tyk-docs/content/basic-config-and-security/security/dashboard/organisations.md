...
Self-Managed users should use [API tagging]({{< ref "advanced-configuration/manage-multiple-environments/with-tyk-on-premises#tyk-self-managed" >}}) and enforce a tagging standard across all organizations.
