...
- API owners can integrate with external Identity Providers (IdPs) supporting methods like OpenID Connect or OAuth 2.0 using [JSON Web Tokens]({{< ref "/api-management/client-authentication#use-json-web-tokens-jwt" >}}).
