...
![mutual_tls_auth]({{< ref "img/2.10/mtls_auth_cert.png" >}})
...
![upstream_cert]({{< ref "img/2.10/attach_upstream_cert.png" >}})

![add_upstream_cert]({{< ref "img/2.10/add_upstream_cert.png" >}})
