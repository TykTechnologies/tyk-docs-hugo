...
![Cache settings]({{< ref "img/2.10/cache_options.png" >}})
...
![Cache options form]({{< ref "img/2.10/advanced_options_designer.png" >}})
...
![Plugin dropdown list]({{< ref "img/2.10/cache_plugin.png" >}})
