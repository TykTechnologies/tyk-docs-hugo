...
As part of using Mutual TLS, you can create a list of trusted certificates. See [Authorization]({{< ref "basic-config-and-security/security/mutual-tls#authorization" >}}) for more details.
