...
![Endpoint designer]({{< ref "img/2.10/url_rewrite.png" >}})

### Step 2: Configure the URL Rewrite Plugin

Add the regex capture groups and the new URL to the relevant sections.

![URL rewrite configuration]({{< ref "img/2.10/url_rewrite_settings.png" >}})
...
![URL rewrite add trigger]({{< ref "img/2.10/url_re-write_advanced.png" >}})

When triggers are added, you can edit or remove them inside the **Advanced URL rewrite** section:

![URL rewrite list trigger]({{< ref "img/2.10/url_rewrite-advanced-edit.png" >}})