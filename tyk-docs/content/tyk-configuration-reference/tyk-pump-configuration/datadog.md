...
- Either a [Tyk Pro install]({{< ref "migration-to-tyk#tyk-self-managed" >}}) or [Tyk OSS Gateway install]({{< ref "migration-to-tyk#tyk-open-source.md" >}}) along with a [Tyk Pump]({{< ref "tyk-pump.md" >}}) install.
