...
- Either a [Tyk Pro install]({{< ref "#configure-tyk-self-managed" >}}) or [Tyk OSS Gateway install]({{< ref "#configure-tyk-self-managed" >}}) along with a [Tyk Pump]({{< ref "tyk-pump.md" >}}) install.
