...
![Step1]({{< ref "img/pump/splunk_step1.png" >}})

C) Select `HTTP Event Collector -> Add New`  
![Step2]({{< ref "img/pump/splunk_step2.png" >}})

D) Set the name to "tyk" and then leave everything else as default
![Step2b]({{< ref "img/pump/splunk_step2b.png" >}})

Grab your token at the end page:
![Step3]({{< ref "img/pump/splunk_step3.png" >}})
...
Success:
![Step4]({{< ref "img/pump/splunk_step4.png" >}})
