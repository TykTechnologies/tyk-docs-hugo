...
Now it is time to publish a new API [Task 5 - Deploy your Cloud Data Plane and add your first API]({{< ref "/content/tyk-cloud/getting-started-tyk-cloud/first-api.md" >}})
