...
![Dashboard Link]({{< ref "img/plugins/control_plane_dashboard_link.png" >}})

2. From the Dashboard screen, click **APIs** from the System Management menu

![APIs Menu]({{< ref "img/plugins/apis_menu.png" >}})
...
![Postman Success]({{< ref "img/plugins/postman_success.png" >}})
...
![Postman All Get Requests]({{< ref "img/plugins/postman_all_get_requests.png" >}})
