...
![Add Portal Page](/docs/4.1/img/2.10/portal-home-page-add.png)
...
![Portal Home page settings](/docs/4.1/img/2.10/portal-home-page-settings.png)

7. Click **Save**.

You should now be able to access your Portal from **Open Your Portal** from the **Your Developer Portal** menu.

![Portal Menu](/docs/4.1/img/2.10/portal_menu.png)
