...
**Request headers** values can be defined as context variables. To know how to refer to request context variables check this [page]({{< ref "/content/context-variables">}}).
