...
![Tyk 2.7 performance]({{< ref "img/diagrams/deployGraph.png" >}})
...
![Tyk 2.7 performance]({{< ref "img/diagrams/deployGraphNoRateLimitQuota.png" >}})
...
![Tyk 2.7 performance]({{< ref "img/diagrams/deployGraphVanilla.png" >}})
