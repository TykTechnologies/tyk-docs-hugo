...
4.  **Group Mapping (Optional but Recommended):** Configure rules to automatically assign users to Tyk AI Studio [Groups]({{< ref "ai-management/user-management" >}}) based on group information received from the IdP.
