...
Tyk Sync works with APIs and Policies. It does not work with Keys. See [Move Keys between environments](/advanced-configuration/manage-multiple-environments/move-keys-between-environments/) for details.
{{< /note >}}
