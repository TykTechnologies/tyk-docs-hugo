...
![Enable DCR](/docs/img/dcr/curity/1-curity-admin-ui-dcr.png)
...
![Configure Split Token API](/docs/img/dcr/curity/4-split-curity-configure-api.png)
...
![DCR API Key](/docs/img/dcr/curity/6-split-dcr-key-curity.png)
...
![Publish API](/docs/img/dcr/curity/7-split-curity-publish-api.png)
...
![Configure DCR](/docs/img/dcr/curity/8-split-curity-configure-dcr.png)
...
![Create OAuth client wizard](/docs/img/dcr/curity/9-split-curity-create-oauth-client-wizard.png)
...
![Application details](/docs/img/dcr/curity/10-split-curity-application-details.png)
...
![DCR client details](/docs/img/dcr/curity/11-split-curity-dcr-client-details.png)
...
![OAuth.tools](/docs/img/dcr/curity/12-split-curity-oauth-tools.png)
...
![Call API](/docs/img/dcr/curity/13-split-curity-external-api-flow.png)

{{< tab_end >}}
{{< tab_start "JWT Approach" >}}

For the JWT Approach, configure the Authentication as outlined in the below screenshot.
![Configure API](/docs/img/dcr/curity/4-jwt-curity-configure-api.png)
...
![Configure policy](/docs/img/dcr/curity/5-jwt-curity-configure-policy.png)

#### Create a Key for the DCR proxy
Navigate to **System Management** &rarr; **Keys**, click `Add Key`. Switch to the `Choose API` tab. Select the previously created `DCR` API. Under `2. Configurations` give the key an alias and set an expiry. Then click `Create Key`.

![DCR API Key](/docs/img/dcr/curity/6-jwt-dcr-key-curity.png)
...
![Publish API](/docs/img/dcr/curity/7-jwt-curity-publish-api.png)

Navigate to the **Settings** tab and check the box `Override global settings`. Then scroll down to the **Dynamic Client Registration for portal APIs** section and toggle the switch to enable. Configure as pictured below:

![Configure DCR](/docs/img/dcr/curity/8-jwt-curity-configure-dcr.png)
...
![Create OAuth client wizard](/docs/img/dcr/curity/9-jwt-curity-create-oauth-client-wizard.png)
...
![Application details](/docs/img/dcr/curity/10-jwt-curity-application-details.png)
...
![DCR client details](/docs/img/dcr/curity/11-jwt-curity-dcr-client-details.png)
...
![OAuth.tools](/docs/img/dcr/curity/12-jwt-curity-oauth-tools.png)
...
![Call API](/docs/img/dcr/curity/13-jwt-curity-external-api-flow.png)
