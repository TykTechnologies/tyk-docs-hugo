...
The full reference for the configuration file is in [the TIB section of the documentation]({{< ref "tyk-oss-gateway/configurationtyk-identity-broker-configuration" >}}).
