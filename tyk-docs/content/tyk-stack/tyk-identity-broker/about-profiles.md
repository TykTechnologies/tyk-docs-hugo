...
| CertLocation        | An X.509 certificate and the private key for signing your requests to the IDP. This should be one single file with the cert and key concatenated. When used in an [embedded TIB instance in the dashboard]({{<ref "tyk-identity-broker/getting-started#installation">}}) then this value can be the *certId* from the certificate manager.                                                                                                           | Yes |
