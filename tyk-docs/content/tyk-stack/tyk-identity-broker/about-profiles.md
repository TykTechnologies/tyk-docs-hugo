...
| Field                            | Description                                                                                                                                                                   | Required                                                         |
|----------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------|
| IDPMetadataURL      | Metadata is an [XML document](https://docs.oasis-open.org/security/saml/v2.0/saml-metadata-2.0-os.pdf) which contains information necessary for interaction with SAML-enabled identity or service providers. The document contains example URLs of endpoints, information about supported bindings, identifiers and public keys. Once you create your TIB profile you can find the SP metadata file under *{Dashboard HOST}/auth/{TIB Profile Name}/saml/metadata* | Yes |
| CertLocation        | An X.509 certificate and the private key for signing your requests to the IDP. This should be one single file with the cert and key concatenated. When used in an [embedded TIB instance in the dashboard]({{<ref "tyk-identity-broker/getting-started#installation">}}) then this value can be the *certId* from the certificate manager. For further details please refer to [SSO with SAML]({{< ref "tyk-stack/tyk-identity-broker/about-profiles" >}})                                                                                                           | Yes |
