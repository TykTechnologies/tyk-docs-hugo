...
Tyk always supports all capabilities described in the latest release of GraphQL specification listed on [GraphQL Foundation webpage]({{< ref https://spec.graphql.org/ >}})
...
source: [GraphQL Foundation website]({{< ref https://graphql.org/>}})
