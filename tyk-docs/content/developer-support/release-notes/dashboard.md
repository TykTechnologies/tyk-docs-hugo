...
1. For Self Managed deployments - Backup Your environment using the [usual guidance]({{<ref "upgrading-tyk#upgrade-guides-toc">}}) documented with every release (this includes backup config file and database).
