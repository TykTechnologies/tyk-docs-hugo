...
2. For all deployments - Backup all your API definitions (Tyk OAS API and Classic Definitions):
   ...
   - For Self-Managed deployments -  To perform the backup please use [Tyk Sync]({{<ref "api-management/automations/sync#synchronize-tyk-environment-with-github-repository" >}}).
...
[_Tyk Sync_]({{< ref "api-management/automations/sync#synchronize-tyk-environment-with-github-repository" >}}). We have now extended this feature and it is now possible to do this without
...
- Added a feature to display a full [_Tyk Sync_]({{<ref "api-management/automations/sync#synchronize-tyk-environment-with-github-repository" >}}) command that will allow a user to import an example UDG into their Dashboard
