...
See our [JWT Scope docs]({{< ref "api-management/authentication/json-web-token" >}}) for more details.
...
[Docs]({{< ref "api-management/traffic-transformation/url-rewriting#url-rewrite-middleware" >}})
