...
##### Get started guides
API Providers can add [Get started guides]({{< ref "portal/api-products#documentation-for-your-api-products" >}}) to API Products for better developer experiences:
...
API Providers can select which blogs posts to display on an API Product page using [the tags feature]({{< ref "portal/api-products#documentation-for-your-api-products" >}}). To achieve that, an API Provider can specify tags for both API Products and blog posts. Blog posts that match tags with an API Product are displayed in the 'Related blog content' section in the API Product page. This offers API Providers greater control over what blog posts to display on their API Product page.
...
- Added the [Get started guides]({{< ref "portal/api-products#documentation-for-your-api-products" >}}) for API Products so that admins can explain to their consumers how use their API Products.
...
- Added [tags]({{< ref "portal/api-products#documentation-for-your-api-products" >}}) for API Products and blog posts so that API Providers have greater control over which blog posts to display on their API Product page.
