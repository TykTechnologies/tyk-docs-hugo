...
We recommend always using the [Long-Term Support (LTS) release]({{< ref "developer-support/special-release-and-features/long-term-support-releases" >}}) for stability and long term support.
