...
To get started with Tyk Self-Managed, you can follow the [Getting Start Guide]({{< ref "getting-started/quick-start" >}}) which provides a step-by-step walkthrough of setting up Tyk in your environment.
