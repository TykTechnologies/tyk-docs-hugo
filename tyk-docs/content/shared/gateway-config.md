...
Minimum TLS version. Possible values: https://tyk.io/docs/certificates#supported-tls-versions
...
Custom SSL ciphers. See list of ciphers here https://tyk.io/docs/certificates#supported-tls-cipher-suites
