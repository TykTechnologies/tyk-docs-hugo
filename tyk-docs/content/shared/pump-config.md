...
[Instrumentation docs]({{< ref "api-management/logs-metrics#statsd-instrumentation" >}}).
...
Enable debugging of Tyk Pump by exposing profiling information, the same as the [gateway]({{< ref "api-management/troubleshooting-debugging" >}})
