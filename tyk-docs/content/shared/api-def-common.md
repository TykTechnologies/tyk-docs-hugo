...
If set to true, this will override ignoring the case for a particular endpoint with the [Ignore]({{< ref "advanced-configuration/transform-traffic/endpoint-designer/#ignore" >}}), [Blocklist]({{< ref "advanced-configuration/transform-traffic/endpoint-designer/#blocklist" >}}){{<fn blocklist>}}{{</fn>}} and [Allowlist]({{< ref "advanced-configuration/transform-traffic/endpoint-designer/#allowlist" >}}){{<fn allowlist>}}{{</fn>}} plugins. This setting can be overriden at a "global" Tyk level by setting `ignore_endpoint_case` to `true` in your `tyk.conf` file. See [ignore_endpoint_case]({{< ref "tyk-configuration-reference/tyk-gateway-configuration-options/#ignore_endpoint_case" >}}) for details.
