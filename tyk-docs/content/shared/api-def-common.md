...
* `config_data`: You can use the config_data field in your API definition to pass custom attributes to middleware via a virtual endpoint. See [Virtual Endpoints]({{< ref "api-management/traffic-transformation#virtual-endpoint-overview" >}}) for more details.
