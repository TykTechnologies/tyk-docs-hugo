...
* `version_data.{version-name}.extended_paths.url_rewrites`: Configuration for the [URL rewrite]({{< ref "api-management/traffic-transformation#url-rewrite-overview" >}}) middleware.
