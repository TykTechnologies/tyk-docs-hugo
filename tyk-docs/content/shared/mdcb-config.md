...
Set to true to disable the Mongo storages default index creation. More detailed behavior explained [here]({{< ref "api-management/tyk-pump.md#omitting-indexes" >}}).
