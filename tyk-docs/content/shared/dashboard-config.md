...
### email_backend
Tyk supports an interface-based email back-end system. We support `mandrill`, `sendgrid`, `amazonses` and `mailgun`. See [Outbound Email Configuration]({{< ref "configure/outbound-email-configuration" >}}) for more details on configuring these different providers.
...
Minimum TLS version. See [TLS and SSL]({{< ref "api-management/certificates" >}}).
...
For more information see [TLS and SSL]({{< ref "api-management/certificates" >}})
