...
In the next diagram every Tyk gateway will search and load the plugin binary that is compatible.
![APIs Menu](/docs/img/plugins/go-plugin-different-tyk-versions.png)
