...
See [ID Extractor](/plugins/rich-plugins/id-extractor/) for more details.
...
- `Session`  - the [Tyk session object](/tyk-apis/tyk-gateway-api/token-session-object-details/).
