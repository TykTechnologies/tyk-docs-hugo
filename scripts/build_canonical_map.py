#!/usr/bin/env python3
"""
Build canonical_map.json for v5.7 by resolving each sitemap URL's
...
Map key:   relative path after /docs/5.7/  e.g. "getting-started/key-concepts/"
...
SITEMAP_URL    = "https://tyk.io/docs/5.7/sitemap.xml"
V55_PREFIX     = "https://tyk.io/docs/5.7/"  # strip this to get the map key
...
def resolve_url(
    ...
    map_key  = path after /docs/5.7/   e.g. "getting-started/key-concepts/"
    final_url = resolved canonical      e.g. "https://tyk.io/docs/api-management/..."
    """
    map_key = v55_url[len(V55_PREFIX):]  # e.g. "getting-started/key-concepts/" (path after /docs/5.7/)
