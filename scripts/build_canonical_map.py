#!/usr/bin/env python3
"""
Build canonical_map.json for v5.2 by resolving each sitemap URL's
old-formula canonical to its final 200 OK destination.

Map key:   relative path after /docs/5.2/
...
SITEMAP_URL    = "https://tyk.io/docs/5.2/sitemap.xml"
V55_PREFIX     = "https://tyk.io/docs/5.2/"
