#!/usr/bin/env python3
"""
Build canonical_map.json for v5.1 by resolving each sitemap URL's
...
Map key:   relative path after /docs/5.1/  e.g. "getting-started/key-concepts/"
...
SITEMAP_URL    = "https://tyk.io/docs/5.1/sitemap.xml"
V55_PREFIX     = "https://tyk.io/docs/5.1/"  # strip this to get the map key
    ...
    with concurrent.futures.ThreadPoolExecutor(max_workers=MAX_WORKERS) as executor:
        ...
        for future in concurrent.futures.as_completed(futures):
            ...
            if status == 200:
                ...
                canonical_map[map_key] = OLD_BASE + map_key.rstrip("/")
