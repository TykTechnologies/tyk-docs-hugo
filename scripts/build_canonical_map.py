#!/usr/bin/env python3
"""
Build canonical_map.json for v4.3 by resolving each sitemap URL's
...
Map key:   relative path after /docs/4.3/  e.g. "getting-started/key-concepts/"
...
SITEMAP_URL    = "https://tyk.io/docs/4.3/sitemap.xml"
V55_PREFIX     = "https://tyk.io/docs/4.3/"  # strip this to get the map key
...
def resolve_url(
    ...
    map_key  = path after /docs/4.3/   e.g. "getting-started/key-concepts/"
