#!/usr/bin/env python3
"""
Build canonical_map.json for v4.1 by resolving each sitemap URL's
...
Map key:   relative path after /docs/4.1/  e.g. "getting-started/key-concepts/"
...
SITEMAP_URL    = "https://tyk.io/docs/4.1/sitemap.xml"
V55_PREFIX     = "https://tyk.io/docs/4.1/"  # strip this to get the map key
OLD_BASE       = "https://tyk.io/docs/"       # prepend to get the URL to resolve
OUTPUT_PATH    = Path("tyk-docs/data/canonical_map.json")
ERRORS_PATH    = Path("tyk-docs/data/canonical_map_errors.json")
